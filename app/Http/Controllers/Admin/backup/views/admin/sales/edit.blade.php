        ...
        <form method="POST" action="{{ route('admin.sales.update', $sale->n_slno) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select id="n_employee_id" name="n_employee_id" required class="form-select">
                        ...
                        <option value="{{ $employee->n_employee_id }}"
                            {{ old('n_employee_id', $sale->n_employee_id) == $employee->n_employee_id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select id="n_product_id" name="n_product_id" required class="form-select">
                        ...
                        <option value="{{ $product->n_product_id }}"
                            {{ old('n_product_id', $sale->n_product_id) == $product->n_product_id ? 'selected' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" id="n_quantity" name="n_quantity"
                        value="{{ old('n_quantity', $sale->n_quantity) }}" min="1" required class="form-control">
                    @error('n_quantity')
                    <div class="text-danger mt-1 fs-2">{{ $message }}</div>
                    @enderror
                </div>
