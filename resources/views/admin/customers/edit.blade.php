            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="c_customer_code"
                        value="{{ old('c_customer_code', $customer->c_customer_code) }}" readonly
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="c_customer_name"
                        value="{{ old('c_customer_name', $customer->c_customer_name) }}" class="form-control mandatory"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="10" name="n_mobile" value="{{ old('n_mobile', $customer->n_mobile) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="10" name="n_whatsapp"
                        value="{{ old('n_whatsapp', $customer->n_whatsapp) }}" class="form-control">
                ...
                <div class="col-md-12">
                    ...
                    <input type="email" name="c_email" value="{{ old('c_email', $customer->c_email) }}"
                        class="form-control">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="c_pincode" name="c_pincode" maxlength="6"
                        value="{{ old('c_pincode', $customer->c_pincode) }}" class="form-control" placeholder="Pincode">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-md-4">
                    ...
                    <select id="c_status" name="c_status" class="form-select mandatory">
                        ...
                        <option value="Y" {{ old('c_status', $customer->c_status) == 'Y' ? 'selected' : '' }}>
                            Active
                        </option>

                        <option value="N" {{ old('c_status', $customer->c_status) == 'N' ? 'selected' : '' }}>
                            Inactive
                        </option>
                    </select>
