    ...
    <div class="card-body p-4 p-md-5">
        <form method="POST" id="frm_create" action="{{ route('admin.employees.store') }}">
            ...
            {{--    <div class="col-md-6" id="store_div">
                    ...
                    <!-- Search input -->
                    <input type="text" id="store_search" class="form-control" placeholder="Search Store...">

                    <!-- Hidden input (this replaces select value) -->
            ...
            --}}
                    ...
                    <div class="p-3 bg-light rounded-3 border">
                        ...
                        <select id="n_operation_manager_id" name="n_operation_manager_id" class="form-select">
                            ...
                            <option value="{{ $opUser->n_employee_id }}"
                                {{ old('n_operation_manager_id') == $opUser->n_employee_id ? 'selected' : '' }}>
               ...
               {{--  <div class="col-12" id="cluster_manager_div" style="display: none;">
                    <div class="p-3 bg-light rounded-3 border">
                        <label for="n_cluster_manager_id" class="form-label">Linked Cluster Managers *</label>
                        <select id="n_cluster_manager_id" name="n_cluster_manager_id[]" multiple class="form-select"
                            style="height: 150px; background-color: #fff;">
                            @foreach($clusterManagers as $manager)
                            <option value="{{ $manager->n_employee_id }}"
                                {{ (is_array(old('n_cluster_manager_id')) && in_array($manager->n_employee_id, old('n_cluster_manager_id'))) ? 'selected' : '' }}>
                                {{ $manager->c_employee_name }} ({{ $manager->c_employee_code }})
                            </option>
                            @endforeach
                        </select>
                        <div class="form-text mt-2" style="font-size: 0.75rem;"><i class="ti ti-info-circle"></i> Hold
                            Ctrl/Cmd to select multiple cluster managers.</div>
                        @error('n_cluster_manager_id')
                        <div class="text-danger mt-1 fs-2">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="col-12" id="cluster_stores_container" style="display: none;">
                    <div class="p-3 bg-light rounded-3 border">
                        <label class="form-label">Linked Stores (For Cluster Manager Only)</label>
