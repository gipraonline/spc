            ...
            <form action="{{ route('admin.field-log.checkin') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control readonly-field" value="{{ now()->format('d-m-Y') }}"
                            readonly>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control readonly-field" value="{{ now()->format('h:i A') }}"
                            readonly>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary editTaskBtn"
                                    data-id="{{ $task->id }}" data-task="{{ $task->task }}"
                                    data-status="{{ $task->status }}" data-remark="{{ $task->pending_remark }}"
