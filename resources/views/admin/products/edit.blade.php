...
<div class="card product-edit-card mb-4">
    ...
    <div class="card-body p-4 p-md-5">
        <form method="POST" id="frm_create" action="{{ route('admin.products.update', $product) }}">
            @csrf @method('PUT')
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <select id="n_category_id" name="n_category_id" class="form-select mandatory"
                        ...
                        {{-- Parent category - not selectable --}}
                        <option disabled>
                        ...
                        <option value="{{ $child->n_category_id }}"
                            {{ old('n_category_id', $product->n_category_id) == $child->n_category_id ? 'selected' : '' }}>
                        ...
                        <option value="{{ $category->n_category_id }}"
                            {{ old('n_category_id', $product->n_category_id) == $category->n_category_id ? 'selected' : '' }}>
                            {{ $category->c_category_name }}
                        </option>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="n_selling_price" data-message="Please enter Selling Price"
                        name="n_selling_price" value="{{ old('n_selling_price', $product->n_selling_price) }}"
                        step="0.01" class="form-control mandatory ">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="c_hsn_code" name="c_hsn_code"
                        value="{{ old('c_hsn_code', $product->c_hsn_code) }}" class="form-control mandatory"
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="n_gst_percentage" name="n_gst_percentage"
                        value="{{ old('n_gst_percentage', $product->n_gst_percentage) }}" class="form-control mandatory"
                ...
                <div class="col-md-6">
                    ...
                    <select id="c_status" name="c_status" class="form-select mandatory">
                        ...
                        <option value="N" {{ old('c_status', $product->c_status) === 'N' ? 'selected' : '' }}>
                            Inactive
                        </option>
                    </select>
            ...
            <div class="pt-5 border-top d-flex gap-3">
                ...
                <a href="{{ route('admin.products.index') }}" class="btn btn-outline-secondary px-4 fw-bold"
