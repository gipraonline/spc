        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="header-left">
                <div class="d-flex align-items-center gap-3">
                    <div class="header-icon-box"
                        style="width: 54px; height: 54px; background: rgba(59, 130, 246, 0.1); color: #3b82f6; display: flex; align-items: center; justify-content: center; border-radius: 16px;">
                        <i class="ti ti-cloud-upload" style="font-size: 1.5rem;"></i>
                    </div>
                    <div>
                        <h5 class="header-title mb-0"
                            style="font-weight: 800; font-size: 1.25rem; letter-spacing: -0.02em;">Bulk Upload Sales
                        </h5>
                        <p class="header-subtitle mb-0" style="color: #64748b; font-size: 0.85rem;">Import and process
                            sales data efficiently</p>
                    </div>
                </div>
            </div>
            <div class="header-right">
                <div class="d-flex gap-2">
                    @if($hasDrafts)
                    <a href="{{ route('admin.sales.drafts') }}" class="btn btn-warning-premium"
                        ...
                        <i class="ti ti-list-details me-2"></i>View Drafts
                    </a>
                    @endif
        ...
        <div class="notification-stack mb-4">
            ...
            <div class="premium-alert alert-warning-premium"
                ...
                <div class="alert-content" style="font-size: 0.9rem; font-weight: 500;">
                    ...
                    <a href="{{ route('admin.sales.drafts') }}" class="alert-link"
            ...
            <div class="col-xl-8 col-lg-10">
                <div class="upload-master-card"
                    ...
                    <div class="card-glass-effect"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: radial-gradient(circle at top right, rgba(59, 130, 246, 0.03), transparent); pointer-events: none;">
                    </div>
                    <div class="upload-card-content p-4 p-md-5" style="position: relative; z-index: 1;">
                        <div class="text-center mb-5">
                            <div class="upload-visual-icon"
                                style="width: 80px; height: 80px; background: #f8fafc; border: 2px solid #eff6ff; border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 2.5rem; color: #3b82f6; box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
                                <i class="ti ti-file-spreadsheet"></i>
                            </div>
                            <h6 class="upload-form-title" style="font-weight: 800; font-size: 1.5rem; color: #1e293b;">
                                Upload Excel File</h6>
                            <div class="column-guidelines mt-3">
                                ...
                                <div class="tag-cloud d-flex flex-wrap justify-content-center gap-2">
                                    <span class="column-pill"
                                        style="background: #f1f5f9; color: #475569; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e2e8f0;">d_date</span>
                                    <span class="column-pill"
                                        style="background: #f1f5f9; color: #475569; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e2e8f0;">c_store_code</span>
                                    <span class="column-pill"
                                        style="background: #f1f5f9; color: #475569; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e2e8f0;">c_billno</span>
                                    <span class="column-pill"
                                        style="background: #f1f5f9; color: #475569; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e2e8f0;">c_item_code</span>

                                    <span class="column-pill"
                                        style="background: #f1f5f9; color: #475569; padding: 4px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700; border: 1px solid #e2e8f0;">n_quantity</span>
                                </div>
                                <p class="warning-note mt-3"
                                    ...
                                    A fresh upload will clear any existing unconfirmed drafts.
                                </p>
                            </div>
                        </div>

                        <form method="POST" action="{{ route('admin.sales.process-bulk-upload') }}"
                            ...
                            <div class="upload-zone mb-4 @error('file') is-invalid-zone @enderror"
                                ...
                                <label for="file" class="upload-label-zone"
                                    style="display: block; width: 100%; padding: 40px 20px; background: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 20px; cursor: pointer; transition: all 0.3s; text-align: center;">
                                    <div class="zone-content">
                                        <i class="ti ti-file-upload zone-icon"
                                            style="font-size: 2.5rem; color: #94a3b8; transition: all 0.3s;"></i>
                                        <div class="zone-text"
                            ...
                            <div class="text-center">
                                @can('bulk-upload.upload')
                                <button type="submit" class="btn btn-process-upload"
                                    style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; padding: 16px 40px; border-radius: 16px; font-weight: 800; font-size: 1.05rem; border: none; box-shadow: 0 10px 20px rgba(37, 99, 235, 0.2); transition: all 0.3s; display: inline-flex; align-items: center; cursor: pointer;">
...
<style>
/* Micro-animations and Hover states (cannot do purely inline) */
