        ...
        <div class="tabpanel active" data-tabpanel="departments">
            <div class="grid-2">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('hr.organization.department.update', $d)); ?>" style="display:flex;gap:6px;">
                                            <?php echo csrf_field(); ?>
                                            <input name="name" value="<?php echo e($d->name); ?>" style="padding:5px 8px;font-size:12.5px;">
                                            <input name="code" value="<?php echo e($d->code); ?>" style="padding:5px 8px;font-size:12.5px;width:70px;">
                                            <button type="submit" class="btn-ghost" style="padding:0;">Save</button>
                                        </form>
                                    </td>
                                    <td><?php echo e($d->code); ?></td>
                                    <td><?php echo e($d->employees_count); ?></td>
                                </tr>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="<?php echo e(route('hr.organization.department.store')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="tabpanel" data-tabpanel="designations">
            <div class="grid-2">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('hr.organization.designation.update', $d)); ?>" style="display:flex;gap:6px;">
                                            <?php echo csrf_field(); ?>
                                            <input name="title" value="<?php echo e($d->title); ?>" style="padding:5px 8px;font-size:12.5px;">
                                            <select name="department_id" style="padding:5px 8px;font-size:12.5px;">
                                                ...
                                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($dep->id); ?>" <?php if($d->department_id === $dep->id): echo 'selected'; endif; ?>><?php echo e($dep->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <button type="submit" class="btn-ghost" style="padding:0;">Save</button>
                                        </form>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="<?php echo e(route('hr.organization.designation.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="field-grid">
        ...
        <div class="tabpanel" data-tabpanel="holidays">
            <div class="grid-2">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Illuminate\Support\Carbon::parse($h->holiday_date)->format('d M Y (D)')); ?></td>
                                    <td><span class="pill <?php echo e($h->is_optional ? 'pill-muted' : 'pill-ok'); ?>"><?php echo e($h->is_optional ? 'Optional' : 'Mandatory'); ?></span></td>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('hr.organization.holiday.destroy', $h)); ?>" onsubmit="return confirm('Remove this holiday?');">
                                            <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="<?php echo e(route('hr.organization.holiday.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="field-grid">
