...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <select id="c_hr_role" name="c_hr_role" class="form-select">
                        <option value="employee" <?php echo e(old('c_hr_role', 'employee') === 'employee' ? 'selected' : ''); ?>>
                            Employee</option>
                        <option value="manager" <?php echo e(old('c_hr_role') === 'manager' ? 'selected' : ''); ?>>Reporting
                            Manager</option>
                        <option value="hr_admin" <?php echo e(old('c_hr_role') === 'hr_admin' ? 'selected' : ''); ?>>HR Admin
                        </option>
                        <option value="super_admin" <?php echo e(old('c_hr_role') === 'super_admin' ? 'selected' : ''); ?>>Super
                            Admin</option>
                    </select>
                    <small class="text-muted d-block mt-1">Role granted inside the HR module.</small>
                    <?php $__errorArgs = ['c_hr_role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
