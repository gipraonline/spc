    ...
    <div class="card page-header-card shadow-sm mb-4">
        ...
        <div class="card-body px-4 py-3">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('admin.admin-log.index')); ?>" class="btn btn-outline-secondary px-3">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-6">
            ...
            <div class="remark-card shadow-sm">
                ...
                <div class="remark-text">
                    <?php echo e($fieldLog->check_in_remark ?: 'No check-in remark provided.'); ?>
        ...
        <div class="col-lg-6">
            ...
            <div class="remark-card shadow-sm">
                ...
                <div class="remark-text">
                    <?php echo e($fieldLog->check_out_remark ?: 'No check-out remark provided.'); ?>
    ...
    <div class="card progress-card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="progress rounded-pill" style="height: 12px;">
                ...
                <div class="progress-bar bg-success rounded-pill" role="progressbar" style="width: <?php echo e($percent); ?>%;"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="fw-semibold text-dark">
                                <?php echo e($task->completed_at->format('d M Y')); ?>

                            </div>

                            <small class="text-muted">
                                <?php echo e($task->completed_at->format('h:i A')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\spc_new\resources\views/admin/admin-log/show.blade.php ENDPATH**/ ?>