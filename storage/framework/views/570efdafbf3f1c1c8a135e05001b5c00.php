        ...
        <div class="card">
            ...
            <div class="form-actions" style="margin:18px 0 20px;">
                ...
                <span class="field-hint" style="margin-left:8px;">
                    Checked in at <?php echo e(\Illuminate\Support\Carbon::parse($todayOwnAttendance->check_in)->format('H:i')); ?>

                </span>
                <?php else: ?>
                <span class="pill pill-ok">Today's attendance completed</span>
                <span class="field-hint" style="margin-left:8px;">
                    <?php echo e(\Illuminate\Support\Carbon::parse($todayOwnAttendance->check_in)->format('H:i')); ?> –
                    <?php echo e(\Illuminate\Support\Carbon::parse($todayOwnAttendance->check_out)->format('H:i')); ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($rec->check_in ? \Illuminate\Support\Carbon::parse($rec->check_in)->format('H:i') : '—'); ?>

                        </td>
                        <td><?php echo e($rec->check_out ? \Illuminate\Support\Carbon::parse($rec->check_out)->format('H:i') : '—'); ?>
                ...
                <form method="POST" action="<?php echo e(route('hr.attendance.regularize')); ?>">
                    ...
                    <div class="field-grid">
                        <div class="field full"><label>Date</label><input type="date" name="attendance_date"
                                value="<?php echo e(now()->toDateString()); ?>" required></div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr data-attendance-department="<?php echo e(strtolower($e->department?->name ?? '')); ?>"
                        ...
                        <td><?php echo e($row->checkIn ? \Illuminate\Support\Carbon::parse($row->checkIn)->format('H:i') : '—'); ?>

                        </td>
                        <td><?php echo e($row->checkOut ? \Illuminate\Support\Carbon::parse($row->checkOut)->format('H:i') : '—'); ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(\Illuminate\Support\Carbon::parse($r->requested_check_in)->format('H:i')); ?>&ndash;<?php echo e(\Illuminate\Support\Carbon::parse($r->requested_check_out)->format('H:i')); ?>
