        ...
        <form action="<?php echo e(route('admin.menus.update',$menu->id)); ?>" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo e(old('name',$menu->name)); ?>"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="route_name" class="form-control"
                        value="<?php echo e(old('route_name',$menu->route_name)); ?>" placeholder="admin.users.index">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\spc\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>