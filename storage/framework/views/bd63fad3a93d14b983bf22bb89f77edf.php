            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo e(old('name', $user->c_name)); ?>"
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="username" class="form-control"
                            value="<?php echo e(old('username', $user->c_username)); ?>" placeholder="example@company.com" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\spc\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>