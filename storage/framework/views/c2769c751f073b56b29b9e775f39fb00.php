           ...
           <div class="row mb-3 align-items-center">
            ...
            <div class="mt-3 d-flex gap-2" >
                <?php if(isset($viewmode) && $viewmode=="on"): ?>
                    ...
                    <!--Approval Button-->
                        <button type="button" style="width:150px;position:relative;" class="btn mt-1 buttonSpc" data-bs-toggle="modal" data-bs-target="#approveModal" data-id="<?php echo e(isset($sale) ? Crypt::encryptString($sale->n_sl_no) : ''); ?>" id="approve">Approve</button>
                    <?php endif; ?>
                <?php else: ?>
                    <button type="button" class="btn mt-1 buttonSpc" id="btn_create"><?php echo e(isset($sale->n_sl_no) ? 'Update' : 'Create'); ?></button>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.salesorders.followup.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="lead_id" value="<?php echo e($sale->n_sl_no->id ?? ''); ?>">
